...
<html>
<head>
	<title>NASI BAKAR MEDUREH</title>
	<link rel="stylesheet" type="text/css" href="css/bootstrap.min.css">
	<link rel="stylesheet" type="text/css" href="css/style.css">
	<link rel="stylesheet" type="text/css" href="css/bootstrap-theme.css">
	<link rel="stylesheet" href="fonts/static/Montserrat-BoldItalic.ttf">
...
<body>
	<div class="container-fluid" style="background-color:#FFF7D4">
		<div class="row top">
			<center>
				<div class="col-md-4" style="padding: 3px;">
   					 <span style="color: white;"><i class="glyphicon glyphicon-earphone"></i> +628123456789</span>
				</div>


				<div class="col-md-4"  style="padding: 3px;">
					<b><span style="color: white; font-size: 16px;">NASI BAKAR MEDUREH</span></b>
				</div>


				<div class="col-md-4" style="padding: 3px;">
   					 <span style="color: white;"><i class="glyphicon glyphicon-envelope"></i> nasibakarmedureh@gmail.com</span>
				</div>
	...
	<nav class="navbar navbar-default" style="padding: 5px;">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#" style="color: #4C3D3D"><b>NASI BAKAR MEDUREH</b></a>
			</div>
