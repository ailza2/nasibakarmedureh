				...
				<ul class="nav navbar-nav navbar-left">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							<li><a href="m_kategori.php">Master Kategori</a></li>
					...
					<!-- <li class="dropdown">
						...
						<ul class="dropdown-menu"> -->
					<li><a href="produksi.php">Pesanan Customer</a></li>
					...
					<!-- <li class="dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="glyphicon glyphicon-stats"></i> Chart <span class="caret"></span></a>
						<ul class="dropdown-menu">
							<li><a href="area_chart.php">Area Chart</a></li>
							<li><a href="bar_chart.php">Bar Chart</a></li>
					...
					<li><a href="halaman_utama.php"> <b> Dashboard </b></a></li>
